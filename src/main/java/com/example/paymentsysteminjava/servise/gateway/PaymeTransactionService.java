package com.example.paymentsysteminjava.servise.gateway;
...
public class PaymeTransactionService {
    ...
    public TransactionEntity createTransaction(TransactionEntity transactionEntity, MerchantServiceEntity merchantServiceEntity){
